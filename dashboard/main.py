...
def serve_layout():
    ...
    return html.Div(
        children=[
            ...
            html.Img(id="image", src=app.get_asset_url(
                f"{curr_time_stamp}.png"), style={"height":"70vh"}),
            dcc.Interval(
...
def update_timestamp(n,session_id):
    ...
    if(os.path.exists(f"assets/{next}.png") and (time.time()-os.path.getmtime(f"assets/{next}.png")>2)):
