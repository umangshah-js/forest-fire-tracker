...
def prediction(npzfile_pth,
    ...
    del  centers, heat, burning_centers, ind, ind2, ind_heat, thresh_max, thresh_min, lim, lim_std, coord, diff, norm
...
if __name__ == "__main__":
    ...
    for i in tqdm(range(0,timestamps)):
        ...
        img_save_path = f"/home/mohit/NYU/Big_Data/Homework/forest-fire-tracker/data/prediction/"
        zarr_save_path = f"/home/mohit/NYU/Big_Data/Homework/forest-fire-tracker/data/zarr/"
        os.makedirs(img_save_path, exist_ok=True)
        os.makedirs(zarr_save_path, exist_ok=True)

        prediction(npzfile_pth, img_save_path=f"{img_save_path}/{i}.png",zarr_save_path=f"{zarr_save_path}/{i}.zarr",f = f)
