...
consumer = KafkaConsumer('image-preprocess',
...
for message in consumer:
    ...
    processed+=1
    producer.send(producer_topic_name, key=key.encode(), value=centers_color_packed).add_callback(on_send_success).add_errback(on_send_error)
    producer.flush()
    print(processed)
